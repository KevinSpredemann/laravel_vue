        ...
        <div class="content-box">
            ...
            <div class="detail-box">
                ...
                <p>
                    ...
                    <span class="detail-content">{{ new Date(props.task.created_at).toLocaleString() }}</span>
                </p>
                <p>
                    <strong class="title-detail-content">Atualizado em:</strong>
                    <span class="detail-content">{{ new Date(props.task.updated_at).toLocaleString() }}</span>
                </p>
            </div>
        </div>
    </AppLayout>
