...
.pagination-container {
    @apply my-2 flex justify-center gap-2;
}

/* Estilo padrão para cada link da paginação */
.pagination-link {
    @apply rounded border px-3 py-1 text-sm transition-colors duration-200;
}

/* Estilo aplicado à página ativa */
.pagination-link-active {
    @apply bg-gray-300 font-bold dark:bg-background;
}
